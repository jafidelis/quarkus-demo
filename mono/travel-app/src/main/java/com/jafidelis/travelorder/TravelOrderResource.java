...
import com.jafidelis.flight.Flight;
import com.jafidelis.flight.FlightResource;
import com.jafidelis.hotel.Hotel;
import com.jafidelis.hotel.HotelResource;
...
public class TravelOrderResource {
    ...
    public List<TravelOrderDTO> orders() {
        return TravelOrder.<TravelOrder>listAll().stream().map(order -> TravelOrderDTO.of(
                        order,
